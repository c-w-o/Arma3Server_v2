...
def build_layout(settings: Settings) -> Layout:
    ...
    return Layout(
        ...
        maps=common / "maps",
        mods=common / "mods",
        servermods=common / "servermods",
        ocap=common / "ocap",
        inst_mods=inst / "mods",
        inst_servermods=inst / "servermods",
        inst_custom_mods=inst / "custom-mods",
...
def ensure_dirs(layout: Layout) -> None:
    for p in [
        ...
        layout.ocap,
        layout.inst_mods,
        layout.inst_servermods,
        layout.inst_custom_mods,
        layout.inst_userconfig,
        layout.inst_config,
        layout.inst_mpmissions,
        layout.inst_logs,
        layout.arma_cfg_dir,
